var canvas1, ctx, W, H;
if (screen.width >= 988) var mp = 80; else mp = 150;
...
function SetGlobals() {
    canvas1 = document.getElementById("my_canvas"), ctx = canvas1.getContext("2d"), W = window.innerWidth, H = window.innerHeight, canvas1.width = W, canvas1.height = H
}
